export default {
  ...
  // 购物车在tab的位置（-1 表示未在 tabBar 展示）
  cartIndex: -1,

  // 消息在tab的位置（-1 代表当前未在 tabBar 中展示）
  notifyIndex: -1,
  ...
  menuTop: [{
    ...
    text: '消息',
    urlType: 'tab',
    url: '/pages/common/notify/notify'
  },
    {
  ...
  settingList: [
    {
      icon: 'iconguizewendang',
      url: '/pages/school/timetable',
      title: '我的课表',
      color: '#ff6b81'
    },
    ...
    // 	url: '/pages/public/url?url={"path":"https://surfplus.jinshuju.net/f/wunNMD"}',
    // 	title: '学员注册',
    // 	color: '#ff6b81'
    // },
    {
    ...
    },
    {
      ...
      url: '/pages/marketing/point/point',
      title: '积分商城',
      color: '#ff6b81'
    },
    {
      icon: 'icondizhi1',
      url: '/pages/common/index/activity?id=62x9aE9Ad0',
      title: '合作申请',
      color: '#ff6b81'
    },
    {
    ...
    // },
    {
      ...
      url: '/pages/marketing/wholesale/my',
      title: '我的拼团',
      color: '#ff6b81'
    },
    {
      icon: 'iconkanjia1',
      url: '/pages/marketing/bargain/my',
      title: '我的砍价',
      color: '#ff6b81'
    },
    // {
    ...
    // { icon: 'iconzhibo', url: '/pages/user/live', title: '直播测试', color: '#ff6b81' },
    {
      ...
      color: '#ff6b81'
    },
		{
			...
			url: '/pages/user/account/drillVerify',
			title: '核销',
			color: '#ff6b81'
		},
    {
  ...
  amountList: [{
    ...
    { title: '成长值', value: 0, url: '/pages/user/account/integral?type=user_growth' },
    { title: '我的账户', icon: 'iconchongzhijilu', url: '/pages/user/account/account' }
  ],
