...
class Setting {
	get miniProgramRegisterGetMobile() {
		return this._miniProgramRegisterGetMobile;
	}

	set miniProgramRegisterGetMobile(value) {
		this._miniProgramRegisterGetMobile = value;
	}

	get protocolMemberCard() {
		return this._protocolMemberCard;
	}

	set protocolMemberCard(value) {
		this._protocolMemberCard = value;
	}

	get protocolMemberCardRights() {
		return this._protocolMemberCardRights;
	}

	set protocolMemberCardRights(value) {
		this._protocolMemberCardRights = value;
	}
	...
	constructor(
		...
		miniProgramRegisterGetMobile,
		protocolMemberCard,
		protocolMemberCardRights
	) {
		...
		this._miniProgramRegisterGetMobile = miniProgramRegisterGetMobile; // 登录是否强制绑定手机号码
		this._protocolMemberCard = protocolMemberCard; // 会员开卡协议
		this._protocolMemberCardRights = protocolMemberCardRights; // 会员权益细则
		// 'protocol_member_card' => '会员开卡协议',
		// 	'protocol_member_card_rights' => '会员权益细则',
	}
