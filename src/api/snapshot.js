...
export const getTodaySnapshot = (date) =>
	http.get('/snapshot/v1/today', { params: { date } });

export const updateTodaySnapshot = (data, date) =>
	http.put('/snapshot/v1/today', data, { params: { date } });

// 餐饮
export const addMeal = (data, date) =>
	http.post('/snapshot/v1/meals', data, { params: { date } });
...
export const completeMeditation = (data, date) =>
	http.post('/snapshot/v1/meditation/complete', data, { params: { date } });

// 历史 / 趋势
export const getSnapshotHistory = (days = 7) =>
	http.get('/snapshot/v1/history', { params: { days } });
