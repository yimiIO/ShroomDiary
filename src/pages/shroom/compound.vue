...
export default {
	...
	computed: {
		...
		canSavePlan() { const d = this.planDraft; return Boolean((this.editingPlanId || d.archetypeKey) && d.title.trim() && d.principalDefinition.trim() && d.desiredOutcome.trim() && d.currentStep.trim()); },
		validationOptions() {
